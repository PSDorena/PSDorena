...
my_words = ["'", 'titanic', 'age', 'sex', 'passengerid', 'survived', 'dataset', 'fare', 'survival', 'middle', 'passenger', 'passengers', 'embarked', "&#9;", '0', 'machine', 'learning', 'notebook', 'ipython', 'data', 'python', 'model', 'feature']
